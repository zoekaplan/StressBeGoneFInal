...
public class SixthAnswer extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sixth_answer);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.imageView_yes:
                Intent i = new Intent(SixthAnswer.this, SeventhQuestion.class);
                startActivity(i);
                break;
            case R.id.imageView_no:
                i = new Intent(SixthAnswer.this, FeelBetter.class);
                startActivity(i);
                break;
        }
    }
